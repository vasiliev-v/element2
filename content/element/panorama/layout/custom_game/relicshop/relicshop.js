...
function UpdtUpgrade()
{
    ...
    if (upgradestone != "")
    {
        ...
        upItemPanel.SetPanelEvent("onmouseover", (function(rsid, inSlot)
        {
            return function()
            {
                $.DispatchEvent("UIShowCustomLayoutParametersTooltip", "RSTooltip", "file://{resources}/layout/custom_game/rs_tooltips/rs_tooltips.xml", "num=" + rsid + inSlot);
            };
        ...
        for(var prop in slots)
        {
            ...
            if (slots[prop] != "0" && slots[prop] != "")
            {
                ...
                imgSlot.SetPanelEvent("onmouseover", (function(rsid)
                {
                    return function()
                    {
                        $.DispatchEvent("UIShowCustomLayoutParametersTooltip", "RSTooltip", "file://{resources}/layout/custom_game/rs_tooltips/rs_tooltips.xml", "num=" + rsid);
                    };
                })(slots[prop]));
