...
function UpdateTooltipPanel(parentPanel, myint, num)
{
    ...
    {
        $.DispatchEvent("UIShowCustomLayoutParametersTooltip", "ParticleTooltip" + myint, "file://{resources}/layout/custom_game/particles_tooltips/particles_tooltips.xml", "num=" + num);
    });
