...
function clinkz_infernal_breath:GetAbilityTextureName() return "clinkz_death_pact" end
...
function modifier_clinkz_infernal_breath:OnAttackLanded(keys)
	...
	local scepter_damage = dmg * (scepter_mag_damage * 0.01)
		if keys.attacker == self:GetParent() then
			...
			local particleName = "particles/ea_items/infernal_breath/clinkz_infernal_breath_hit.vpcf"
