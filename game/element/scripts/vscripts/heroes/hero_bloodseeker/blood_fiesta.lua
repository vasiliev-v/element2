...
function blood_fiesta:OnAbilityPhaseStart()
	self:PlayEffects1()
	self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_black_king_bar_immune", { duration = 2 })
	return true
end
...
function blood_fiesta:PlayEffects1()
	local particle_precast = "particles/ea_abilities/fear_end.vpcf"
