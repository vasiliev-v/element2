...
LinkLuaModifier( "modifier_axe_ult", "abilities/my_new_axe_ult", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_ult_timer", "abilities/my_new_axe_ult", LUA_MODIFIER_MOTION_NONE )
...
function my_new_axe_ult:OnSpellStart()
	...
	self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_axe_ult_timer", { duration = timer } )
end
