modifier_dragon_area_ignite_thinker = class({})

----------------------------------------------------------------------------------------

function modifier_dragon_area_ignite_thinker:OnCreated( kv )
	if IsServer() then
...
function modifier_dragon_area_ignite_thinker:OnImpact()
	if IsServer() then
		...
		ParticleManager:SetParticleControl( nFXIndex, 2, Vector( 10, 0, 0 ) );
...
function modifier_dragon_area_ignite_thinker:OnIntervalThink()
	if IsServer() then
