...
function part_mod:GetEffectName()
    ...
    "particles/econ/courier/courier_roshan_lava/courier_roshan_lava.vpcf",--P lvl 1
    "particles/econ/courier/courier_roshan_ti8/courier_roshan_ti8_flying.vpcf",--P lvl 2
    "particles/econ/courier/courier_greevil_red/courier_greevil_red_ambient_3.vpcf",--P lvl 3
    "particles/units/heroes/hero_skeletonking/wraith_king_ghosts_ambient.vpcf",--P lvl 4
    "particles/econ/items/dazzle/dazzle_ti6_gold/dazzle_ti6_shallow_grave_gold.vpcf",--P lvl 5
    "particles/econ/courier/courier_platinum_roshan/platinum_roshan_ambient.vpcf",--молнии платиного рошана
    "particles/econ/courier/courier_roshan_frost/courier_roshan_frost_ambient.vpcf",--др2
    --------------------------------------------------------------------------------------------------------------------------------
    ...
    "particles/econ/items/skywrath_mage/hero_skywrath_dpits3_wings/skywrath_dpits3_backwing_p.vpcf",
